...
MODEL_SAVE_FREQUENCY = 1000             # Frequency in episodes to save model
REPLAY_MEMORY_SIZE = 50000             # Size of experience replay memory
...
DECAY_RATE = 0.99                        # The rate at which epsilon decays. E.g., if 0.1, epsilon will be divided by 10 after every decay_frames number of frames, until it is less than or equal to final_epsilon. Useless if decay_mode == 'single'.
DQN_LEARNING_RATE = 0.00025             # Learning rate for DQN
GAMMA = 0.99                            # Discount factor for future rewards
DQN_UPDATE_FREQUENCY = 1                # Number of actions taken between successive SGD updates
