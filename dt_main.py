...
from utils.data_transforms import image_transformation_crop_downscale_norm, image_transformation_just_norm, image_transformation_crop_downscale, image_transformation_grayscale_crop_downscale
